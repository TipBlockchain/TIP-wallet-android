 ...
 * [MoreFragment.OnListFragmentInteractionListener] interface.
 */
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                MoreContent.context = this.context
                adapter = MyMoreItemRecyclerViewAdapter(context, MoreContent.items, listener)
            }
        }
...
//            throw RuntimeException(context.toString() + " must implement OnListFragmentInteractionListener")
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onListFragmentInteraction(item: MoreListItem?)
    }
