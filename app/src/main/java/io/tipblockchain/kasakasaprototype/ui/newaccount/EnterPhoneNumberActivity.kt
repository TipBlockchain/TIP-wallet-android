...
class EnterPhoneNumberActivity : AppCompatActivity(), LoaderCallbacks<Cursor> {
    ...
    private fun attemptLogin() {
        ...
        val firstnameStr = fistnameTv.text.toString()
        val usernameStr = usernameTv.text.toString()
        ...
        if (TextUtils.isEmpty(firstnameStr)) {
            fistnameTv.error = getString(R.string.error_invalid_password)
            focusView = fistnameTv
            cancel = true
        }

        if (!cancel && TextUtils.isEmpty(usernameStr)) {
            usernameTv.error = getString(R.string.error_field_required)
        ...
        if (cancel) {
            ...
            showProgress(true)
            mAuthTask = UserLoginTask(firstnameStr, usernameStr)
